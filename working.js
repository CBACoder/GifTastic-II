$(document).ready(function() {
    ...
    let topics =["computing", "computer virus","Hard Disk", "macntosh","hp"];
    ...
    $(".btn btn-primary").on("click",function(){
        ...
        var queryUrl = "https://api.giphy.com/v1/gifs/search?q="+topicName+"&api_key="+apikey+"&limit=10"
    ...
    $("#topic-button").on("click",function(){
        ...
        console.log('call button render here');
        renderButtons();
        //clear the text the user entered
        $("#add-topic").val("");
    });

    // render the buttons afresh
    function renderButtons(){
        ...
        for (let i=0; i<topics.length; i++){
            ...
            //on click image, change the status
    $(".gif").on("click",function(){
        // this code is not activated, troubleshot but could not reach a solution.
